...
<head>
    ...
    <title>Tienda insumos - CropTech</title>
            ...
            <div class=" row">
                            ...
                            <a href="#" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                                <svg class="bi me-2" width="40" height="32"><use xlink:href="#bootstrap"></use></svg>
                                    ...
                                    <ul class="nav nav-pills flex-column mb-auto">
                                        ...
                                        <li>
                                        <a href="http://localhost/proyecto_grado/croptech/vista/ver_insumo.php?idc=3" class="nav-link active">
                ...
                <div class="col p-5 text-center bg-light border border-success">
                    ...
                    <div id="page-content-wrapper">
                        <div class="container-fluid">
                            <h1>Tiendas categoría insumos</h1>
                            <hr>
                            <?php   
