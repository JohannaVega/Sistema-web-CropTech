...
<html lang="en">
    <head>
        ...
        <title> Cultivos activos - CropTech </title>
    ...
    <body>
        ...
        <?php 
            ...
            $obj_1=new facade();
            $exist=$obj_1-> validar_cultivos_user_active($idu);

            $obj_2=new facade();
            $resul=$obj_2-> read_cultivos_user_active($idu);
        ...
        ?>
             ...
             <div class="m-1 row justify-content-center">
                <div class="col-auto p-3 text-center ">
                    <h1 class="display-5 text-success text-shadow h1">Actualiza los datos de tus cultivos activos!!</h1>
                    <hr>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table id="tmedicos" class="table table-striped table-light">
                                ...
                                <tbody>
                                    ...
                                    <td><a href="http://localhost/proyecto_grado/croptech/vista/cultivo_condiciones_ambientales.php?idSiembra=<?php echo $resul[$i]['nro_registro_siembra'];?>"
                        ...
                        { ?>
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <h1>¡No cuentas con cultivos activos!</h1>
                                </div>

                                <div class="row justify-content-center">
                                    <div class="col-auto text-center">
                                        <img src="http://localhost/proyecto_grado/croptech/assets/img/tomate.gif" alt="Heyy"  height="200px" width="200px"></a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
