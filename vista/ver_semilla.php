...
<head>
    ...
    <title>Tienda semillas - CropTech</title>
...
<body>
    ...
    <!--TRAIGO LOS DATOS DE TIENDAS POR CATEGORIA-->
    <?php 
        if(isset($_GET['idc'])){
            ...
            <div class=" row">
                            ...
                            <a href="#" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                                <svg class="bi me-2" width="40" height="32"><use xlink:href="#bootstrap"></use></svg>
                                    ...
                                    <ul class="nav nav-pills flex-column mb-auto">
                                        <li class="nav-item">
                                        <a href="http://localhost/proyecto_grado/croptech/vista/ver_proveedores.php" class="nav-link text-white">
                                        ...
                                        <li>
                                        <a href="http://localhost/proyecto_grado/croptech/vista/ver_semilla.php?idc=2" class="nav-link active">
                ...
                <div class="col p-5 text-center bg-light border border-success">
                    ...
                    <div id="page-content-wrapper">
                        <div class="container-fluid">
                            <h1>Tiendas categoría semillas</h1>
                            <hr>
                            <?php   
    ...
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.6.0/dist/umd/popper.min.js" 
        ntegrity="sha384-KsvD1yqQ1/1+IA7gi3P0tyJcT3vR+NdBTt13hSJ2lnve8agRGXTTyNaBYmCR/Nwi" 
         crossorigin="anonymous">
    </script>
