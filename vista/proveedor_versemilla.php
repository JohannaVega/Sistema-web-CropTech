...
<body> 
       ...
       <?php 
                        ...
                        <div class="caja_trasera"> 
                            ...
                            <div class="d-flex flex-column p-3 text-white" style="width: 280px;">
                                    ...
                                    <ul class="nav nav-pills flex-column mb-auto">
                                        <li class="nav-item">
                                        <a href="http://localhost/proyecto_grado/croptech/vista/proveedor_ver.php" class="nav-link text-white">
                                        ...
                                        <li>
                                        <a href="http://localhost/proyecto_grado/croptech/vista/proveedor_versemilla.php?idc=2" class="nav-link active">
        ...
        <?php 
            ...
            window.location='proveedor_ver.php';
            </script>";
