...
<head>
    ...
    <title>Registro admon - CropTech</title>
                        ...
                        <div class="col-auto p-5 bg-light border border-success">
                            <div class="jumbotron">
                                <div id= "contenedor-name">
                                    ...
                                    <p class="text-center text-shadow">Administrador</p>
                                    <hr>
                                </div>
                                 <!--SECCIÓN FORMULARIO-->
                                <form action="../controlador/validarlogin.php" method="post">
                                    ...
                                    <div class="form-row row justify-content-center p-2">
                                        <div class="form-group col-md-8">
                                        <label>Sexo:</label>
                                        <select class="form-select form-select mb-1" id="sexo" name="sexo" required>
                                    ...
                                    <div class="form-row row justify-content-center p-2">
                                        <div class="form-group col-md-8">
                                            ...
                                            <?php echo $roles[2]['id_rol_usuario'];?>
                                            ...
                                            <input type="hidden" name="rol" value='<?php echo $roles[2]['id_rol_usuario'];?>'>
                                        </div>
                                    </div>
                                     <!--SECCIÓN feedback-->
