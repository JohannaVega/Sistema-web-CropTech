...
<head>
    ...
    <title>Registro proveedor - CropTech</title>
                        ...
                        <div class="col-auto p-5 bg-light border border-success">
                            <div class="jumbotron">
                                <div id= "contenedor-name">
                                    ...
                                    <p class="text-center text-shadow">Proveedor</p>
                                    <hr>
                                </div>
                                 <!--SECCIÓN FORMULARIO-->
                                <form action="../controlador/validarlogin.php" method="post">
                                    ...
                                    <div class="form-row row justify-content-center p-2">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="hidden" name="rol" value='<?php echo $roles[1]['id_rol_usuario'];?>'>
                                        </div>
                                    </div>
                                     <!--SECCIÓN feedback-->
                                    ...
                                    <button type="submit"  class="btn btn-outline-success btn-lg" value="CREAR_UP" 
